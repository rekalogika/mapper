...
class MixedTypeTest extends FrameworkTestCase
{
    ...
    {
        $object = new ObjectWithMixedProperty();
        $result = $this->mapper->map($object, ObjectWithMixedPropertyDto::class);
        $this->assertSame('foo', $result->property);
    }

    public function testUntyped(): void
    {
        $object = new ObjectWithMixedProperty();
        $result = $this->mapper->map($object, ObjectWithUntypedPropertyDto::class);
        $this->assertSame('foo', $result->property);
    }
}
